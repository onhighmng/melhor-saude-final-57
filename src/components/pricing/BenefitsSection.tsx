      ...
      {membershipType === 'individual' ? (
        <>
          ...
          <div className="mb-8 p-6 bg-green-50 rounded-2xl border border-green-100">
            ...
            <p className="text-green-800 text-lg leading-relaxed">
              Sessões ilimitadas com profissionais disponíveis 24 horas por dia, 7 dias por semana, acesso completo aos 4 pilares, agendamento seguro e suporte via chat.
            </p>
          </div>
        ...
        <div className="mb-8 p-6 bg-blue-50 rounded-2xl border border-blue-100">
          ...
          <p className="text-blue-800 text-lg leading-relaxed">
            Acesso completo aos 4 pilares de bem-estar com especialistas disponíveis 24 horas por dia, 7 dias por semana, sessões ilimitadas, relatórios de bem-estar e suporte dedicado.
          </p>
        </div>
      )}
    </div>
