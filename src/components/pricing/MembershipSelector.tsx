  ...
  return (
    <div className="flex flex-row items-center gap-5">
      ...
      >
        ...
        <div className="text-xs leading-[13.8px] tracking-[-0.048px]">Para pequenas empresas</div>
      </button>
      <button
      ...
      >
        ...
        <div className="text-xs leading-[13.8px] tracking-[-0.048px]">Para médias e grandes empresas</div>
      </button>
    </div>
  );
};
