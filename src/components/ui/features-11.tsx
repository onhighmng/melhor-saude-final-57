...
export function Features({ company }: FeaturesProps) {
            ...
            <section className="py-8">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="mx-auto grid gap-2 sm:grid-cols-2">
                        ...
                        <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-1 sm:rounded-none sm:rounded-tl-xl">
                            <CardHeader>
                        ...
                        {/* Affiliates Card */}
                        <Card className="group shadow-zinc-950/5 sm:col-span-1 sm:rounded-none sm:rounded-tr-xl">
                            <CardHeader>
                                <div className="md:p-6">
                        ...
                        <Card className="group p-6 shadow-black/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl sm:rounded-br-xl md:p-12">
