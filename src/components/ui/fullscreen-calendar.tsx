                ...
                <div
                  ...
                  className={cn(
                    ...
                    !isEqual(day, selectedDay) &&
                      ...
                      !isSameMonth(day, firstDayCurrentMonth) &&
                      "bg-gray-50",
                    "relative flex flex-col border-b border-r hover:bg-muted focus:z-10 h-24 cursor-pointer",
                ...
                >
                  <header className="flex items-center justify-between p-2">
                    <button
                      ...
                      className={cn(
                        ...
                        (isEqual(day, selectedDay) || isToday(day)) &&
                          "font-semibold",
                        "flex h-7 w-7 items-center justify-center rounded-full text-base hover:border font-semibold",
                      )}
                    >
                  ...
                  <div className="flex-1 p-2 overflow-hidden">
                    {data
                      ...
                      .map((dayData) => (
                        <div key={dayData.day.toString()} className="flex flex-wrap gap-1">
                          {dayData.events.map((event) => (
                            <div
                              ...
                              className={cn(
                                "h-8 w-8 rounded-full flex items-center justify-center text-white text-[10px] font-bold cursor-pointer hover:opacity-80 transition-opacity",
                                getPillarColor(event.pillar || '')
                              )}
                              title={event.name}
                            >
            ...
            {days.map((day, dayIdx) => (
              ...
              >
                <time
                  dateTime={format(day, "yyyy-MM-dd")}
                  className={cn(
                    "ml-auto flex size-7 items-center justify-center rounded-full text-sm font-semibold",
                    isEqual(day, selectedDay) &&
                      isToday(day) &&
                      "bg-primary text-primary-foreground",
                    isEqual(day, selectedDay) &&
