  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Confirme a sua marcação</h2>
        <p className="text-sm text-muted-foreground">Reveja os detalhes da sua sessão</p>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Button 
          ...
          className="flex-1"
        >
          {isConfirming ? 'A confirmar...' : 'Confirmar marcação'}
        </Button>
      </div>
    </div>
  );
