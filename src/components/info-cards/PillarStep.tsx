...
const PillarStep: React.FC<PillarStepProps> = ({
  ...
  const pillarImages = [
    "/lovable-uploads/8e2df1aa-a1c7-4f91-b724-fc348e3347ee.png", // Saúde Psicológica
    ...
    "/lovable-uploads/f48e9a64-fcb0-4691-baa9-c6007ac1a750.png"  // Saúde Jurídica e Social
  ];
