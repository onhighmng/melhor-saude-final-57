...
const LegalChatInterface: React.FC<LegalChatInterfaceProps> = ({
  ...
  useEffect(() => {
    document.body.classList.add('legal-assessment-page');
    return () => {
      document.body.classList.remove('legal-assessment-page');
    };
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="absolute top-0 left-0 flex items-center gap-4 px-8 py-6 z-10">
        ...
        <div>
          <h2 className="text-3xl font-semibold">Assistente Jurídico</h2>
        </div>
