    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-primary">
          Selecione as situações que gostaria de abordar
        </p>
      </div>

      <div className="flex flex-wrap gap-3 justify-center items-center px-4">
        {financialAssistanceSymptoms.map((symptom, index) => {
      ...
      <div className="space-y-3">
        ...
        <Textarea
          ...
          placeholder="Partilhe mais detalhes sobre a sua situação financeira..."
