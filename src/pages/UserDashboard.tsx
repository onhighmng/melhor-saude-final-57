    ...
    <div className="relative z-10 h-full flex flex-col">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-4 h-full flex flex-col min-h-0">
        ...
        <div className="flex-1 min-h-0">
          ...
          <BentoCard name="Próximas Sessões" description={`${upcomingBookings?.length || 0} sessões agendadas`} href="#" cta="" Icon={Calendar} onClick={() => navigate('/user/sessions')} className="lg:col-start-3 lg:col-end-3 lg:row-start-2 lg:row-end-4" background={<div className="absolute inset-0 p-5 flex flex-col justify-between">
