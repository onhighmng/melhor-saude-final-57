                      ...
                      <div className="space-y-4 flex-1 flex flex-col justify-center">
                        <div className="p-5 bg-gray-100 rounded-xl border border-gray-200 transition-all duration-200 hover:bg-gray-200 hover:shadow-md hover:scale-[1.02] cursor-pointer">
                          <div className="flex justify-between items-center mb-3">
                            ...
                            <span className="text-2xl font-bold text-purple-700">
                              {analytics?.sessions_allocated && analytics?.sessions_used 
                                ? Math.round((analytics.sessions_used / analytics.sessions_allocated) * 100) 
                                : 0}%
                            </span>
                          </div>
                          <Progress 
                            value={analytics?.sessions_allocated && analytics?.sessions_used 
                              ? Math.round((analytics.sessions_used / analytics.sessions_allocated) * 100) 
                              : 0} 
                            className="h-3" 
                          />
                        ...
                        <div className="p-5 bg-gray-100 rounded-xl border border-gray-200 transition-all duration-200 hover:bg-gray-200 hover:shadow-md hover:scale-[1.02] cursor-pointer">
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-2xl font-bold text-purple-700">{analytics?.active_prestadores || 0}</span>
                          </div>
